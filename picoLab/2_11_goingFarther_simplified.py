...
melody = [[note_c4, note_c4, note_b3, note_b3, note_e3, note_g3, note_e3, note_e3, note_c4, note_c4, note_b3, note_b3, note_e3,     
           ...
           note_c4, note_c4, note_b3, note_b3, note_e3, note_g3, note_e3, note_g3, note_a3, note_fs3, note_g3, note_e4], # note hz

          [100, 100, 100, 100, 100, 50, 150, 100, 100, 100, 100, 100, 400,      
           100, 100, 100, 100, 100, 100, 200, 100, 100, 100, 100, 300,    
           100, 100, 100, 100, 100, 50, 150, 100, 100, 100, 100, 100, 400,      
           100, 100, 100, 100, 100, 100, 200, 100, 100, 100, 100, 300], # note duration in ms

          [100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,     
           100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 200,    
           100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,     
           100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 200]] # rest in ms
...
_thread.start_new_thread(servo, ()) # starts the second thread

print("starting main")
for num in range(len(melody[0])): # the main for loop
    note_hz = melody[0][num] # gets the hz, duration, and rest
    note_duration = melody[1][num]
    note_rest = melody[2][num]

    if octive(note_hz) == 3: # checks if octive is 3 or 4
        voctive = 3 # tells the other thread its octive 3
        p_led_blue.value(0) # controls the leds
        p_led_white.value(1)
    else:
        voctive = 4
        p_led_white.value(0)
    ...
    tone(p_buzzer, note_hz, note_duration, note_rest) # plays the tone
